...
import { AnimationSpeed, Config as ChessBoardConfig } from '@Chess/Board/Types';
import { DEFAULT_CONFIG as DEFAULT_SETTINGS_CHESSBOARD } from '@Chess/Board/ChessBoard';
import {
    LogConsole,
