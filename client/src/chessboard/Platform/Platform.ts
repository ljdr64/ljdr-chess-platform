...
import { NavigatorModal } from './Components/NavigatorModal.ts';
import {
...
import { LogConsole } from './Components/NavbarComponents/LogConsole.ts';
...
import { BotAttributes } from '@ChessPlatform/chessboard/Chess/Bot/index.ts';
/**
...
export class Platform {
    ...
    */
    ...
    private _createBoardAndHandleComponents(
        ...
        if (!BoardEditor.isEditorModeEnable()) {
            ...
            if (notation && typeof notation !== 'string')
                throw new Error(
                    'Notation type must be string while piece editor is active.'
                );
    ...
    public preparePlatformForOnlineGame(
        ...
        if (playerColor !== this.chess.getTurnColor()) this.chess.board.lock();
    ...
    private _playAgainSingleplayerGame(): void {
        ...
        if (botAttributes)
            botAttributes.color =
                botAttributes.color == Color.White ? Color.Black : Color.White;
