import { NavbarOperation } from '@ChessPlatform/chessboard/Platform/Types';
...
export class Navbar extends Component {
    ...
    private _showNavbarButtonAsActive(navbarComponent: NavbarComponent): void {
        ...
        if (navbarOperation) {
            document
                .querySelector(`.navbar-buttons button.active`)
                ?.classList.remove('active');
            document
                .querySelector(
                    `.navbar-buttons [data-menu-operation="${navbarOperation}"]`
                )
