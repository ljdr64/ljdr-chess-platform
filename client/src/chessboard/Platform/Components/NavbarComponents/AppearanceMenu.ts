...
import { APPEARANCE_MENU_ID } from '@ChessPlatform/chessboard/Platform/Consts';
...
export class AppearanceMenu extends NavbarComponent {
    ...
    private loadLocalStorage(): void {
        ...
        if (Store.isExist(StoreKey.CustomAppearance)) {
            const customAppearance = Store.load(StoreKey.CustomAppearance);
    ...
    private loadColorPalette(): void {
        ...
        if (Store.isExist(StoreKey.CustomAppearance))
            customAppearance = Store.load(StoreKey.CustomAppearance);
