...
import { Platform } from '@ChessPlatform/chessboard/Platform/Platform';
import { Logger } from '@ChessPlatform/chessboard/Services/Logger';
...
import { PlatformEvent } from '@ChessPlatform/chessboard/Platform/Types';
import type {
...
import { Page } from '@ChessPlatform/chessboard/Global/Page';
...
export class ChessPlatform {
    ...
    private _onMessage:
        | (<T extends WsTitle>(wsTitle: T, wsData: WsData<T>) => void)
        | null = null;
    ...
    private init(): void {
        ...
        const connectToLastConnectionOrLobbyUrl = async () => {
            const lsLobbyId = Store.load(StoreKey.LastLobbyConnection)?.lobbyId;
