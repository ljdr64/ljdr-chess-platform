...
import { throttle } from '@ChessPlatform/chessboard/Utils/Timing.ts';
...
export class ChessBoard {
    ...
    private handleSquareClick(
        ...
        onPieceMovedByClicking:
            | ((squareId: Square, squareClickMode: SquareClickMode) => void)
            | null = null,
        ...
        if (this._isTouchDevice()) {
            ...
            const targetSquare = elements.find(
                (e) =>
                    ...
                    ].includes(this.getSquareClickMode(e as HTMLElement))
            ) as HTMLElement;
