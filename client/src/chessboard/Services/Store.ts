import { BotAttributes } from '@ChessPlatform/chessboard/Chess/Bot';
import { JsonNotation } from '@ChessPlatform/chessboard/Chess/Types';
import { Theme } from '@ChessPlatform/chessboard/Platform/Components/NavbarComponents/AppearanceMenu';
import { WsCreatedData } from '@ChessPlatform/chessboard/Types';
import { Settings } from '@ChessPlatform/chessboard/Platform/Components/NavbarComponents/SettingsMenu';
...
export class Store {
    ...
    public static save<K extends StoreKey>(key: K, value: StoreData[K]): void {
        if (!Object.values(StoreKey).includes(key)) throw new Error('');
