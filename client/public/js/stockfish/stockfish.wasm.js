...
function setValue(e, r, t, n) {
    switch (
        ((t = t || 'i8'), '*' === t.charAt(t.length - 1) && (t = 'i32'), t)
    ) {
        case 'i1':
        case 'i8':
            HEAP8[e >> 0] = r;
        ...
        ((a =
            t == ALLOC_NONE
                ...
                : [
                      ...
                      staticAlloc,
                      dynamicAlloc,
                  ][void 0 === t ? ALLOC_STATIC : t](
                      Math.max(i, u ? 1 : r.length),
                  )),
        o)
    ) {
        var s;
        for (n = a, assert(0 == (3 & a)), s = a + (-4 & i); n < s; n += 4)
            HEAP32[n >> 2] = 0;
...
function UTF8ArrayToString(e, r) {
    for (var t = r; e[t]; ) ++t;
    if (t - r > 16 && e.subarray && UTF8Decoder)
...
function integrateWasmJS() {
    ...
    function o(r, t, o) {
        ...
        if (
            ((t.memory = Module.wasmMemory),
            (s.global = { NaN: NaN, Infinity: 1 / 0 }),
            (s['global.Math'] = Math),
            (s.env = t),
        ...
        return (
            ...
            'function' != typeof fetch
                ...
                : WebAssembly.instantiateStreaming(
                      ...
                      .catch(function (e) {
                          Module.printErr(
                              'wasm streaming compile failed: ' + e,
                          ),
                              Module.printErr(
    ...
    'function' == typeof Module.locateFile &&
        (isDataURI(i) || (i = Module.locateFile(i)),
        isDataURI(a) || (a = Module.locateFile(a)),
        isDataURI(u) || (u = Module.locateFile(u)));
    var s = {
            global: null,
            env: null,
            asm2wasm: {
    ...
    var c = Module.reallocBuffer,
        d = function (e) {
            ...
            if (Module.usingWasm)
                try {
                    return -1 !== Module.wasmMemory.grow((e - t) / 65536)
...
function ___syscall140(e, r) {
    ...
    try {
        ...
        return (
            ...
            t.getdents && 0 === a && 0 === i && (t.getdents = null),
            0
        );
    } catch (e) {
        return (
...
function ___syscall91(e, r) {
    ...
    try {
        ...
        if (n === o.len) {
            ...
            SYSCALLS.doMsync(t, i, n, o.flags),
                FS.munmap(i),
                (SYSCALLS.mappings[t] = null),
                o.allocated && _free(o.malloc);
        }
        return 0;
    } catch (e) {
        return (
...
function ___buildEnvironment(e) {
    ...
    ___buildEnvironment.called
        ? ((t = HEAP32[_environ >> 2]), (r = HEAP32[t >> 2]))
...
function _strftime(e, r, t, n) {
    ...
    for (var f in p)
        d.indexOf(f) >= 0 && (d = d.replace(new RegExp(f, 'g'), p[f](c)));
    ...
    return (
        (onmessage = function (r) {
            'quit' == r.data
                ...
                : null !== e
                  ? e.push(r.data)
                  : Module.ccall('uci_command', 'number', ['string'], [r.data]);
        }),
        {
            ...
            postRun: function () {
                for (var r = 0; r < e.length; r++)
                    Module.ccall('uci_command', 'number', ['string'], [e[r]]);
                e = null;
            },
        }
    );
        ...
        ? ('undefined' != typeof read &&
          ...
          (Module.readBinary = function (e) {
              ...
              return 'function' == typeof readbuffer
                  ...
                  : ((r = read(e, 'binary')), assert('object' == typeof r), r);
          }),
...
var ERRNO_CODES = {
            ...
            get_char: function (e) {
                if (!e.input.length) {
                    ...
                    if (ENVIRONMENT_IS_NODE) {
                        ...
                        a && fs.closeSync(i),
                            (r =
                                n > 0 ? t.slice(0, n).toString('utf-8') : null);
                    } else
    ...
    MEMFS = {
        ...
        stream_ops: {
            read: function (e, r, t, n, o) {
                ...
                else for (var u = 0; u < a; u++) r[t + u] = i[o + u];
                return a;
            },
            write: function (e, r, t, n, o, i) {
                ...
                else for (var u = 0; u < n; u++) a.contents[o + u] = r[t + u];
    ...
    IDBFS = {
        ...
        getLocalSet: function (e, r) {
            ...
            for (
                var o = {},
                    i = FS.readdir(e.mountpoint).filter(t).map(n(e.mountpoint));
                i.length;
                ...
                FS.isDir(a.mode) &&
                    i.push.apply(i, FS.readdir(u).filter(t).map(n(u))),
                    (o[u] = { timestamp: a.mtime });
            }
            return r(null, { type: 'local', entries: o });
        },
        ...
        reconcile: function (e, r, t) {
            ...
            (l.onerror = function (e) {
                ...
                i.sort().forEach(function (e) {
                    'local' === r.type
                        ? IDBFS.loadRemoteEntry(c, e, function (r, t) {
                              if (r) return n(r);
                ...
                a
                    ...
                    .forEach(function (e) {
                        'local' === r.type
                            ? IDBFS.removeLocalEntry(e, n)
                            : IDBFS.removeRemoteEntry(c, e, n);
                    });
        },
    },
    NODEFS = {
    ...
    WORKERFS = {
        ...
        mount: function (e) {
            function r(e) {
                for (
                    var r = e.split('/'), t = n, i = 0;
                    i < r.length - 1;
                    i++
                ) {
                    var a = r.slice(0, i + 1).join('/');
                    o[a] ||
                        (o[a] = WORKERFS.createNode(
                            t,
                            r[i],
                            WORKERFS.DIR_MODE,
                            0,
...
var FS = {
        ...
        lookupPath: function (e, r) {
            if (((e = PATH.resolve(FS.cwd(), e)), (r = r || {}), !e))
        ...
        symlink: function (e, r) {
            ...
            var t = FS.lookupPath(r, { parent: !0 }),
                n = t.node;
        ...
        rename: function (e, r) {
            var t,
                ...
                s = PATH.basename(r);
            try {
                (t = FS.lookupPath(e, { parent: !0 })),
                    (n = t.node),
                    (t = FS.lookupPath(r, { parent: !0 })),
                    (o = t.node);
            } catch (e) {
                throw new FS.ErrnoError(ERRNO_CODES.EBUSY);
            }
            ...
            if ('.' !== c.charAt(0))
                throw new FS.ErrnoError(ERRNO_CODES.EINVAL);
            if (((c = PATH.relative(r, i)), '.' !== c.charAt(0)))
                throw new FS.ErrnoError(ERRNO_CODES.ENOTEMPTY);
            var d;
            try {
                d = FS.lookupNode(o, s);
        ...
        open: function (e, r, t, n, o) {
            ...
            if (
                (FS.isChrdev(i.mode) && (r &= -513),
                65536 & r && !FS.isDir(i.mode))
            )
                throw new FS.ErrnoError(ERRNO_CODES.ENOTDIR);
            if (!a) {
        ...
        createLazyFile: function (e, r, t, n, o) {
            ...
            if (
                ...
                (i.prototype.cacheLength = function () {
                    ...
                    s.setDataGetter(function (e) {
                        ...
                        if (
                            ((t = Math.min(t, n - 1)),
                            void 0 === s.chunks[e] && (s.chunks[e] = u(r, t)),
                            void 0 === s.chunks[e])
                        )
            ...
            return (
                ...
                (l.read = function (e, r, t, n, o) {
                    ...
                    else for (var u = 0; u < a; u++) r[t + u] = i.get(o + u);
                    return a;
                }),
                (s.stream_ops = l),
                s
            ...
            function n() {
                ...
                (document.fullscreenElement ||
                    ...
                    ? ((o.exitFullscreen =
                          ...
                          function () {}),
                      (o.exitFullscreen = o.exitFullscreen.bind(document)),
            ...
            o.parentNode.insertBefore(i, o),
                ...
                (i.requestFullscreen =
                    ...
                    (i.webkitRequestFullScreen
                        ...
                        : null)),
                t
                    ? i.requestFullscreen({ vrDisplay: t })
                    : i.requestFullscreen();
        },
        requestFullScreen: function (e, r, t) {
            return (
        ...
        calculateMouseEvent: function (e) {
            if (Browser.pointerLock)
                ...
                (d *= t / r.width),
                    ...
                    (Browser.mouseMovementY = _ - Browser.mouseY),
                    (Browser.mouseX = d),
                    (Browser.mouseY = _);
            }
        },
...
var __GLOBAL__I_000101 = (Module.__GLOBAL__I_000101 = function () {
    ...
    __GLOBAL__sub_I_bitbase_cpp = (Module.__GLOBAL__sub_I_bitbase_cpp =
        function () {
            return Module.asm.__GLOBAL__sub_I_bitbase_cpp.apply(
                null,
                arguments,
            );
        }),
    __GLOBAL__sub_I_bitboard_cpp = (Module.__GLOBAL__sub_I_bitboard_cpp =
        function () {
            return Module.asm.__GLOBAL__sub_I_bitboard_cpp.apply(
                null,
                arguments,
            );
        }),
    __GLOBAL__sub_I_endgame_cpp = (Module.__GLOBAL__sub_I_endgame_cpp =
        function () {
            return Module.asm.__GLOBAL__sub_I_endgame_cpp.apply(
                null,
                arguments,
            );
        }),
    __GLOBAL__sub_I_evaluate_cpp = (Module.__GLOBAL__sub_I_evaluate_cpp =
        function () {
            return Module.asm.__GLOBAL__sub_I_evaluate_cpp.apply(
                null,
                arguments,
            );
        }),
    __GLOBAL__sub_I_iostream_cpp = (Module.__GLOBAL__sub_I_iostream_cpp =
        function () {
    ...
    __GLOBAL__sub_I_material_cpp = (Module.__GLOBAL__sub_I_material_cpp =
        function () {
            return Module.asm.__GLOBAL__sub_I_material_cpp.apply(
                null,
                arguments,
            );
        }),
    ...
    __GLOBAL__sub_I_movegen_cpp = (Module.__GLOBAL__sub_I_movegen_cpp =
        function () {
            return Module.asm.__GLOBAL__sub_I_movegen_cpp.apply(
                null,
                arguments,
            );
        }),
    __GLOBAL__sub_I_movepick_cpp = (Module.__GLOBAL__sub_I_movepick_cpp =
        function () {
            return Module.asm.__GLOBAL__sub_I_movepick_cpp.apply(
                null,
                arguments,
            );
        }),
    __GLOBAL__sub_I_pawns_cpp = (Module.__GLOBAL__sub_I_pawns_cpp =
        function () {
            return Module.asm.__GLOBAL__sub_I_pawns_cpp.apply(null, arguments);
        }),
    __GLOBAL__sub_I_position_cpp = (Module.__GLOBAL__sub_I_position_cpp =
        function () {
            return Module.asm.__GLOBAL__sub_I_position_cpp.apply(
                null,
                arguments,
            );
        }),
    ...
    __GLOBAL__sub_I_search_cpp = (Module.__GLOBAL__sub_I_search_cpp =
        function () {
    ...
    __GLOBAL__sub_I_timeman_cpp = (Module.__GLOBAL__sub_I_timeman_cpp =
        function () {
            return Module.asm.__GLOBAL__sub_I_timeman_cpp.apply(
                null,
                arguments,
            );
        }),
    ...
    __GLOBAL__sub_I_ucioption_cpp = (Module.__GLOBAL__sub_I_ucioption_cpp =
        function () {
            return Module.asm.__GLOBAL__sub_I_ucioption_cpp.apply(
                null,
                arguments,
            );
        }),
