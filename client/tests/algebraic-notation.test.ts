...
const algeNotTestGames: TestGame[] = [
    ...
    },
    {
        ...
        moves: [{ from: Square.e8, to: Square.e6 }],
        expectation: ['ree6'],
    },
    {
        // https://en.wikipedia.org/wiki/Algebraic_notation_(chess)#Disambiguating_moves
        ...
        board: '4r3/k7/7r/8/8/8/K7/8 b - - 1 1',
        moves: [{ from: Square.h6, to: Square.e6 }],
        expectation: ['rhe6'],
    },
    {
        // https://en.wikipedia.org/wiki/Algebraic_notation_(chess)#Disambiguating_moves
        ...
        moves: [{ from: Square.d8, to: Square.f8 }],
        expectation: ['rdf8'],
    },
    {
        // https://en.wikipedia.org/wiki/Algebraic_notation_(chess)#Disambiguating_moves
    ...
    },
    {
        ...
        moves: [{ from: Square.h4, to: Square.e1 }],
        expectation: ['Qh4e1'],
    },
    {
        // https://en.wikipedia.org/wiki/Algebraic_notation_(chess)#Disambiguating_moves
    ...
    },
    {
        ...
        board: '8/k7/8/8/4Q2Q/8/8/K6Q w - - 0 1',
        moves: [{ from: Square.e4, to: Square.e1 }],
        expectation: ['Qee1'],
    },
    {
        // https://en.wikipedia.org/wiki/Algebraic_notation_(chess)#Disambiguating_moves
        ...
        board: '8/k7/8/8/4Q2Q/8/8/K6Q w - - 0 1',
        moves: [{ from: Square.h1, to: Square.e1 }],
        expectation: ['Q1e1'],
    },
];
